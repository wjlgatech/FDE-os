...
![Map · Ladder · Gate — draw the whole territory, drop depth on demand, prove it works](assets/mlg-thumbnail.png)
...
![Map → Ladder → Gate → Teach: width, depth, proof, retention — one loop, repeated per domain](assets/mlg-map-ladder-gate.png)
...
![Kid-word → real thing → why it works, with the citations and the definition of "better"](assets/mlg-term-mapping.png)
