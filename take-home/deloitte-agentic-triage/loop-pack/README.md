...
during the Deloitte interview: solution overview, gap audit + 10X, all 8 core modules
...
2. Select the **"Deloitte Agentic AI Take-Home"** playbook (built-in as of loop PR #33
   on the default branch — rebuild the app to see it; priority 12, auto-triggers on
   deloitte/take-home/triage/golden dataset/…).
3. `playbook.md` already carries the delimited `DELOITTE-TAKEHOME` cheat-sheet block —
