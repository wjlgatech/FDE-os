...
module.exports = async (req, res) => {
  ...
  const r = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 700,
      system:
        "You are the copilot for a personal interview take-home presentation (an agentic procurement-triage system). " +
        ...
        "The 10X content is a PROPOSAL — never describe it as implemented. " +
