...
# dual-location: in the repo the corpus sits at ../corpus/extracted; in the
# vendored serverless bundle it sits right next to this file.
_LOCAL = os.path.join(_HERE, "corpus", "extracted")
EXTRACTED = _LOCAL if os.path.isdir(_LOCAL) else os.path.join(
    os.path.dirname(_HERE), "corpus", "extracted")
