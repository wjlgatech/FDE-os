...
# dual-location: in the repo, the graph core is imported from take-home #1 by
# path (compose, never re-implement); in the vendored serverless bundle a
# byte-identical graph.py sits next to this file.
_TRIAGE = (_HERE if os.path.exists(os.path.join(_HERE, "graph.py"))
